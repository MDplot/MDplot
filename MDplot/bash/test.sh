...
# hbond
Rscript MDplot_bash.R hbond files=../inst/extdata/hbond_example.txt title="Hbonds plot" size=1200,900 resolution=165 acceptorRange=90,125 outformat=tiff outfile=hbond.tiff
